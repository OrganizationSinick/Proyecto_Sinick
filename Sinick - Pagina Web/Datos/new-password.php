            ...
            <div class="col-md-4 offset-md-4 form">
                ...
                <div align="center"><img src="../Image/Logo 3.png" class="logo" alt="Logo"></div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="password" name="password" placeholder="Crear nueva contraseña" required>
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="password" name="cpassword" placeholder="Confirme la contraseña" required>
                    </div>
                    <div class="form-group">
